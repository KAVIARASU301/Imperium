...
class CVDSingleChartDialog(QDialog):
    ...
    def _draw_confluence_lines(
        ...
        if self._is_chop_regime(closed_idx, strategy_type=strategy_type):
            return
    ...
    def _run_trade_simulation(
        ...
        for idx in range(length):
            ...
            if self._is_chop_regime(idx, strategy_type=signal_strategy):
                result["skipped"] += 1
    ...
    def _is_chop_regime(self, idx: int, strategy_type: str = None) -> bool:
        """
